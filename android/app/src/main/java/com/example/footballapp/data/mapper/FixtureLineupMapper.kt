    ...
    FixtureLineupUiModel(
        ...
        teams = teams.map { team ->
            ...
            FixtureTeamLineupUiModel(
                ...
                colors = team.colors?.let { colors ->

                    FixtureTeamColorsUiModel(

                        player =
                            colors.player?.let { player ->
                        ...
                        goalkeeper =
                            colors.goalkeeper?.let { goalkeeper ->

                                FixturePlayerColorsUiModel(

                                    primary = goalkeeper.primary,

                                    number = goalkeeper.number,

                                    border = goalkeeper.border
